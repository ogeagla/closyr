...
- [ ] Bug: Webapp / Job Results when job is done / stopped: it seems to show prior job's scoring method and maybe other things. it needs to show the data for the done/stopped job.
